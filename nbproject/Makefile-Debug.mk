...
${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/upgrade_to_cpp: ${OBJECTFILES}
	...
	${LINK.cc} -o ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/upgrade_to_cpp ${OBJECTFILES} ${LDLIBSOPTIONS} -lboost_system -lboost_timer -lboost_chrono -lrt
...
${OBJECTDIR}/classes_test.o: classes_test.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
...
${OBJECTDIR}/dynamic_allocation.o: dynamic_allocation.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/dynamic_allocation.o dynamic_allocation.cpp
